...
- Open positions use executable-quote profit targets, stop losses, the model's maximum holding time, and portfolio loss/drawdown exits. Every entry needs at least 30 minutes before the earliest effective deadline; directional spreads are capped at 60 minutes and must exit at least 15 minutes before the next scheduled macro event. The daily entry window ends at 3:20 PM ET and the normal daily hard exit is 3:50 PM; Thursday retains its earlier competition-wide 2:30 PM entry cutoff and forced liquidation starts by 3:15 PM. Soft exits use quote-aware bounded backoff while urgent safety exits retain aggressive bounded concessions. The internal flat target is 3:45 PM, and Alpaca's 4:00 PM EOD equity is the authoritative measurement. Close-only recovery persists until broker positions and relevant working orders confirm flat.
- The dashboard's primary countdown targets Thursday's authoritative 4:00 PM ET equity lock. Friday's 11:00 AM ET submission deadline is context only, not additional trading time.
